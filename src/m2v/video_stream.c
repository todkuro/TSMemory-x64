...
typedef int (* RAW_CLOSE)(intptr_t);
typedef int (* RAW_READ)(intptr_t, void *, unsigned int);
typedef __int64 (* RAW_SEEK)(intptr_t, __int64, int);
typedef __int64 (* RAW_TELL)(intptr_t);
